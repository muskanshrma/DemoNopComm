...
public class ComparisonPage {
    ...
    By loginButton = By.xpath("//button[contains(text(), 'Continue')]");
    ...
    public void compare() throws IOException {
        ...
        boolean isCompareDisplayed = driver.findElement(comparisonPageVerification).isDisplayed();
        Assert.assertTrue(isCompareDisplayed, "Can not compare");
    }
}